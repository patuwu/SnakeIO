...
public class SnakeGame extends JPanel implements ActionListener {
    ...
    public void initGame()  {
        Player1 = new Snake(AllSquare, 3, 1, 50, head, body);
        Player2 = new Snake(AllSquare, 3, 2, 350, headE, bodyE);
...
//######################################## BAGIAN MEKANISME ########################################
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (gameState == 1) {          
            ...
            ERandom();
            if(Player1.checkCollision(Player2, WindowW) == 0) { winner = 2; gameState =4;}
            if(Player2.checkCollision(Player1, WindowW) == 0) { winner = 1; gameState =4;}
    ...
    public void ERandom() {
        ...
        if(chance <= 75){
            if(Player2.getDir() > 2) {
                if(Player2.getX() < apple_x) Player2.setDir(2);
                else Player2.setDir(1);
            }
            else {
                if(Player2.getY() < apple_y) Player2.setDir(4);
                else Player2.setDir(3);
            }
        }
    }
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (key == KeyEvent.VK_LEFT){
                if(Player1.getDir() != 2) Player1.setDir(1);
            }

            if (key == KeyEvent.VK_RIGHT){
                if(Player1.getDir() != 1) Player1.setDir(2);
            }

            if (key == KeyEvent.VK_UP){
                if(Player1.getDir() != 4) Player1.setDir(3);
            }

            if (key == KeyEvent.VK_DOWN){
                if(Player1.getDir() != 3) Player1.setDir(4);
            }
        }
    }
}